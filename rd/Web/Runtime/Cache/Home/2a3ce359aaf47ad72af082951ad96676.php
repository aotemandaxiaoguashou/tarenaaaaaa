...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
	...
	<div class="w pb20">
        ...
        <div class="ui-nav-crumbs pt10 text-overflow">
             <a href="/rd/index.php/Home/Assigner/index">首页</a><i>&gt;</i><a href="/rd/index.php/Home/Assigner/index">布置师</a><i>&gt;</i>作品
        </div>
...
<ul class="clx">
	<li>
		<a href="/rd/index.php/Home/Assigner/work/id/<?php echo ($vo["id"]); ?>" class="on">
			作品<i></i>			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Assigner/serve/id/<?php echo ($vo["id"]); ?>">
			服务
			<b class="arrow"></b>
		</a>
	</li>
		...
		<a href="/rd/index.php/Home/Assigner/special/id/<?php echo ($vo["id"]); ?>">
			专栏<i></i>			<b class="arrow"></b>
                ...
                <div class="ui-nav-sub pt20">
                                            <a href="/rd/index.php/Home/Assigner/index" class="on">布置师</a>
                                    </div>
                <!-- 没有列表数据显示 -->
                                    <!-- 数据列表如果没有数据不显示循环li标签 -->
                    ...
                    <ul class="opus-list-ul" id="j-list">
                                ...
                                <li class="mode-7">
                                    ...
                                    <div class="opus-title">
                                        ...
                                        <div class="fl">
                                            <h4>
                                                <a href="/rd/index.php/Home/Assigner/workInfo/id/<?php echo ($vos["id"]); ?>" style="font-size:20px;"><?php echo ($vos["xname"]); ?></a>
                                            </h4>
                                        </div>
                                        <div class="fr">
                                            <span></span>
