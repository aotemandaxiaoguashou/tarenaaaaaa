...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
	...
	<div class="pl30 fl author-info pt16">
		...
		<div class="author-hit">
			<p>
				<i class="icons icon-19"></i>赞<i class="num">6</i>
			</p>
			<p>
				<i class="icons icon-20"></i>浏览<i class="num">23</i>
			</p>
		</div>
                <!--易结价-->
...
<ul class="clx">
	...
	<li>
		<a href="/rd/index.php/Home/Planner/special/id/<?php echo ($vo["id"]); ?>" class="on">
                    ...
                    <ul class="opus-list-ul" id="j-list">
                                ...
                                <li class="mode-7">
                                    ...
                                    <div class="opus-title">
                                        ...
                                        <div class="fl">
                                            <h4>
                                                <a href="/rd/index.php/Home/Planner/specialInfo/id/<?php echo ($vos["id"]); ?>"  style="font-size:21px;"><?php echo ($vos["xname"]); ?></a>
                                            </h4>
                                        </div>
                                        <div class="fr">
                                            <span></span>
