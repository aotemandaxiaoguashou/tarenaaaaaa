	...
	<ul class="fl">
        ...
        <div class="ui-nav-crumbs text-overflow pt10">
            <a href="/rd/index.php/index">首页</a><i>&gt;</i>
									...
									<a href="/rd/index.php/Home/Designer/index">造型师</a><i>&gt;</i>
																																							<a href="/rd/index.php/Home/Designer/work/"></a>造型师<i>&gt;</i>
			造型师的        </div>
		<!-- 面包屑end-->
			...
			<div class="wrap-fr fr">
                ...
                <div class="opus-d-author">
                    <div class="ui-photo c150-150-2">
                        <a href="/rd/index.php/Home/Designer/work/id/<?php echo ($vos["id"]); ?>" target="_blank">
                            <img width="150" height="150" src="/rd/Public/Uploads/marriager/<?php echo ($vos["pic"]); ?>" alt="<?php echo ($vos["name"]); ?>">
                            <i class="hack"></i>
                        </a>
                    </div>
                    <div class="title text-overflow">
                        <a href="/rd/index.php/Home/Designer/work/id/<?php echo ($vos["id"]); ?>" target="_blank"><?php echo ($vos["name"]); ?></a>
                    </div>
                    <div class="job">
						                        <span>
                            <i class="icons  icon-job-3"></i>造型师                        </span>
						                    </div>
                    <div class="hit">
                        <span class="item-1 text-overflow">
                            <i class="icons icon-19"></i>赞<i id="j-zan-num" class="num">6</i>
                        </span>
