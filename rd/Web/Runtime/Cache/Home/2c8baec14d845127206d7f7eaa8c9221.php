...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
	...
	<ul class="fl">
        ...
        <div class="ui-nav-crumbs text-overflow pt10">
            <a href="/rd/index.php/index">首页</a><i>&gt;</i>
			
				<a href="/rd/index.php/Home/Compere/index">主持人</a><i>&gt;</i>
																				
			婚礼的舞台上主持人应该找到自己的位置        </div>
		<!-- 面包屑end-->
                ...
                <div class="opus-d-author">
                    <div class="ui-photo c150-150-2">
                        <a href="/rd/index.php/Home/Compere/work/id/<?php echo ($vos["id"]); ?>" target="_blank">
                            <img width="150" height="150" src="/rd/Public/Uploads/marriager/<?php echo ($vos["pic"]); ?>" alt="主持人洪峰">
                            <i class="hack"></i>
                        </a>
                    </div>
