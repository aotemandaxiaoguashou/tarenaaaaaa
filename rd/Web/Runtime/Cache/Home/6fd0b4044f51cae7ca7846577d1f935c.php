	...
	<div class="main-cont fl">
		<div class="cate-list mb15">
			<div class="cate-bd">
				...
				<?php if(is_array($decoration)): $i = 0; $__LIST__ = $decoration;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$deco): $mod = ($i % 2 );++$i;?><li>
						<div class="img-box">
							<a href="/rd/index.php/Home/Goods/detail/id/<?php echo ($deco["id"]); ?>"><img src="/rd/Public/Uploads/goods/<?php echo ($deco["pic"]); ?>" alt="白绿色系花艺套餐" width="316" height="235"></a>
						</div>
						<div class="img-name">
							<a href="/rd/index.php/Home/Goods/detail/id/<?php echo ($deco["id"]); ?>"><?php echo ($deco["goodsname"]); ?></a>
						</div>
						<div class="price-box">
							<strong>酷结价：￥<?php echo ($deco["price"]); ?>&nbsp;&nbsp;<i>市场价：<del>￥<?php echo ($deco["mar-price"]); ?></del></i></strong>
						</div>
