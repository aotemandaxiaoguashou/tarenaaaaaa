...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
	...
	<div class="ui-nav-crumbs pt10 text-overflow">
		<a href="/rd/index.php/Home/Compere/index">首页</a><i>&gt;</i><a href="/rd/index.php/Home/Compere/index">找婚礼人</a><i>&gt;</i>报价
	</div>
	<!--面包屑结束-->
	<!--主题内容开始-->
...
<ul class="clx">
	...
	<li>
		<a href="/rd/index.php/Home/Compere/special/id/<?php echo ($vo["id"]); ?>" class="on">
                    ...
                    <ul class="opus-list-ul" id="j-list">
                                ...
                                <li class="mode-7">
                                    ...
                                    <div class="opus-title">
                                        ...
                                        <div class="fl">
                                            <h4>
                                                <a href="/rd/index.php/Home/Compere/specialInfo/id/<?php echo ($vos["id"]); ?>" style="font-size:21px;"><?php echo ($vos["xname"]); ?></a>
                                            </h4>
                                        </div>
                                        <div class="fr">
                                            <span></span>
