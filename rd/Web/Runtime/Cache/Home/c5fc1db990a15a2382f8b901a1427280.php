...
<html>
  ...
  <title>作品展示-<?php echo ($wlist["title"]); ?></title>
  ...
  <link charset="utf-8" rel="stylesheet" href="/rd/Public/css/laydate.css">
  <link charset="utf-8" rel="stylesheet" href="/rd/Public/css/laydate_002.css">
...
<div class="w pb20"> 
  <!-- 面包屑 -->
  <div class="ui-nav-crumbs text-overflow pt10"> <a href="/rd/index.php">首页</a><i>&gt;</i><a href="/rd/index.php/Home/Works" target="_self">作品区</a><i>&gt;</i><?php echo ($wlist["title"]); ?></div>
  <!-- 面包屑end-->
  ...
  <div class="wrap clx pt10 opus-d">
    <div class="wrap-fl fl">
      <dl class="opus-d-info">
        ...
        <dd class="clx">
          <div class="info"> <strong>地点：</strong><span><?php echo ($wlist["hole_name"]); ?></span></div>
          <div class="info"> <strong>时间：</strong> <span><?php echo (date('Y-m-d H:i:s',$wlist["addtime"])); ?></span> </div>
        </dd>
        <dt>
          <h2>提供的服务</h2>
        </dt>
        <dd class="clx">
          <div class="info"> <strong>服务：</strong> <span>室内婚礼</span><span><?php echo ($wlist["price"]); ?>元</span> </div>
        </dd>
      </dl>
      <h3 class="ui-h2 mt20">新人档案</h3>
      <div class="opus-d-content pt10"><?php echo ($wlist["presoninfo"]); ?></div>
      <h3 class="ui-h2 mt20">新人婚礼要求</h3>
      <div class="opus-d-content pt10"><?php echo ($wlist["requires"]); ?> </div>
      <h3 class="ui-h2 mt20">服务亮点</h3>
      <div class="opus-d-content pt10"> 圣诞 </div>
      <div class="opus-d-img pt20" id="j-img-list">
        <div class="title"> 作品图片区 </div>
        <ul>
          <!-- 图片列表循环, 循环li标签 -->
          <li>
            <div class="pic">  
              <?php echo ($wlist["detail"]); ?>
            </div>
          </li>    
        </ul>
      </div>
