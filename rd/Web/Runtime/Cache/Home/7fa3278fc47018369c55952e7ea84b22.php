...
<div class="nav">
	<div class="allshow">
		<?php if(is_array($holes)): $i = 0; $__LIST__ = $holes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hole): $mod = ($i % 2 );++$i;?><ul style="width:270px;">
