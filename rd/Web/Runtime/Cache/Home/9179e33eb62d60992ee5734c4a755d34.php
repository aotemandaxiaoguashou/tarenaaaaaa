...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
    ...
    <div class="ui-nav-class  clx">
		<ul class="fl">
					...
					<li><a href="/rd/index.php/designer/index" class="on">婚礼造型</a></li>
	...
	<div class="w pb20">
        ...
        <div class="ui-nav-crumbs pt10 text-overflow">
             <a href="/rd/index.php/index">首页</a><i>&gt;</i><a href="/rd/index.php/Home/Designer/index">找婚礼人</a><i>&gt;</i>作品
        </div>
			...
			<h2 class="text-overflow"><?php echo ($vo["name"]); ?></h2>
                ...
                <div class="vendors-easywed-rz mt10">
            		...
            		<div class="author-address pt10">
						<span><i class="icons  icon-job-3"></i>造型师</span>
					</div>

		<div class="author-hit">
			<p>
				<i class="icons icon-19"></i>赞<i class="num">44</i>
			</p>
			<p>
...
<ul class="clx">
	<li>
		<a href="/rd/index.php/Home/Designer/work/id/<?php echo ($vo["id"]); ?>" class="on">
			作品<i></i>			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Designer/serve/id/<?php echo ($vo["id"]); ?>">
			服务
			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Designer/price/id/<?php echo ($vo["id"]); ?>">
			报价
			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Designer/special/id/<?php echo ($vo["id"]); ?>">
			专栏<i></i>			<b class="arrow"></b>
                ...
                <div class="ui-nav-sub pt20">
                                            <a href="/rd/index.php/Home/Designer/index" class="on">造型师</a>
                                    </div>
                <!-- 没有列表数据显示 -->
                                    <!-- 数据列表如果没有数据不显示循环li标签 -->
                    ...
                    <ul class="opus-list-ul" id="j-list">
                                ...
                                <li class="mode-7">
                                    ...
                                    <div class="opus-title">
                                        ...
                                        <div class="fl">
                                            <h4>
                                                <a href="/rd/index.php/Home/Designer/workInfo/id/<?php echo ($vos["id"]); ?>" style="font-size:20px;"><?php echo ($vos["xname"]); ?></a>
                                            </h4>
                                        </div>
                                        <div class="fr">
                                            <span></span>
