...
<html>
	...
	<script type="text/javascript" src="/rd/Public/js/WdatePicker.js"></script><link type="text/css" rel="stylesheet" href="%E4%BC%9A%E5%91%98%E4%B8%AD%E5%BF%83-%E4%B8%AA%E4%BA%BA%E4%BF%A1%E6%81%AF%E7%AE%A1%E7%90%86-CoolMarry-%E9%85%B7%E7%BB%93%E7%BD%91_files/WdatePicker.css">
...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
  ...
  <span>当前位置：</span><a href="/rd/index.php/Index/index">首页</a>&gt; <em>会员中心</em>
</div>
  ...
  <div class="maincont fr">
    ...
    <div class="clearfix user-content">
      <div class="clearfix p10 mb10">
        <p>帮助我们完善您的个人信息，有助于我们末来根据您的情况提供更加个性化的服务;我们会对您的个人资料隐私加以保密。</p>
        <table class="user-tab4" width="100%" cellpadding="0" cellspacing="0">
          <form method="post" action="/rd/index.php/Home/User/adduser">
            <tr><td class="passwordl">用户名：</td><td><?php echo ($_SESSION[C('SESSION_USER')]['username']); ?><span></span></td></tr>
            <tr><td class="passwordl"><em>*</em>真实姓名：</td><td><input class="tab4-txt" id="tname" name="tname" type="text"><span></span></td></tr>
