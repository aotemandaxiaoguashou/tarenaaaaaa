...
<div class="container">
	<div id="main">
		...
		<div class="row area">
			...
			<div class="box2">
				<h3><?php echo ($list["cat_name"]); ?></h3>
				<ul class="article">
					<?php if(empty($art_title)): ?>没有文章
					<?php else: ?>
					<?php if(is_array($art_title)): foreach($art_title as $key=>$vo): ?><li><span class="right"><?php echo (date("Y-m-d H:i:s",$vo["addtime"])); ?></span><a href="/rd/index.php/Home/Article/articlelist/id/<?php echo ($list["cat_id"]); ?>">[<?php echo ($list["cat_name"]); ?>]</a> <a href="/rd/index.php/Home/Article/articleinfo/id/<?php echo ($vo["article_id"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; endif; ?>
				</ul>
			</div>
		</div>	
