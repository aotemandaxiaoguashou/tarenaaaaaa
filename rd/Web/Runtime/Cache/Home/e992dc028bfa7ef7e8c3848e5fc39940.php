...
<html>
	...
	<title><?php echo ($content["title"]); ?>—文章内容</title>
	...
	<link href="/rd/Public/css/layout.css" rel="stylesheet" />
	<link href="/rd/Public/css/commons.css" rel="stylesheet" />
	<link href="/rd/Public/css/user.css" rel="stylesheet" />
	<script src="/rd/Public/js/jquery.min.js"></script>
	<script src="/rd/Public/js/bootstrap.min.js"></script>
	<script src="/rd/Public/js/jquery.superslide.2.1.1.js"></script>
	<script src="/rd/Public/js/index.js"></script>
...
<div class="container">
	<div id="main">
		...
		<div class="row area">
			<!--左侧-->
			<div class="span3 area_l">
			<!--左侧文章分类-->
				<div class="box">
					<h3>文章分类</h3>
					<ul class="list_help">
					<?php if(is_array($article)): foreach($article as $key=>$vo): ?><li><h4><i class="icon-tag"></i><a href="/rd/index.php/Home/Article/articlelist/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["cat_name"]); ?></a></h4></li>
					<?php if(is_array($vo)): foreach($vo as $key=>$v2): if(is_array($v2)): foreach($v2 as $key=>$v3): ?><li><h5><a href="/rd/index.php/Home/Article/articleinfo/id/<?php echo ($v3["article_id"]); ?>"><?php echo ($v3["title"]); ?></a></h5></li><?php endforeach; endif; endforeach; endif; endforeach; endif; ?>				
					</ul>
				</div>
			</div>
			...
			<div class="span9 area_r">
				<div class="box2">
					<h2 class="artTitle highlight"><?php echo ($content["title"]); ?></h2>
					<p class="artTime">时间: <?php echo (date("Y-m-d H:i:s",$content["addtime"])); ?></p>
					<div class="artcontent"><a href="#"></a><p><?php echo ($content["content"]); ?></p></div>
					<div class="next_page highlight">
					上一篇： <?php if(empty($last_text)): ?>没有了<?php else: ?><a href="/rd/index.php/Home/Article/articleinfo/id/<?php echo ($last_text["article_id"]); ?>"class="highlight"><?php echo ($last_text["title"]); ?></a><?php endif; ?> <br>
					下一篇： <?php if(empty($next_text)): ?>没有了<?php else: ?><a href="/rd/index.php/Home/Article/articleinfo/id/<?php echo ($next_text["article_id"]); ?>"class="highlight"><?php echo ($next_text["title"]); ?></a><?php endif; ?> <br>				
					</div>
				</div>
			</div>	
...
<div class="row area">
		  <div class="leftCloumns well span2 Cloumnsright">
			<div class="l_menu">
				<h3><i class="open"></i>婚纱推荐</h3>
				<ul id="uid" style="overflow:hidden">
					<?php if(is_array($deslist)): $i = 0; $__LIST__ = $deslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="cc"><a href="/rd/index.php/Home/Dresses/info/id/<?php echo ($vo["id"]); ?>"><img src="/rd/Public/<?php echo ($vo["pic_name"]); ?>" style="width:40px;height:30px;"><?php echo (strdel($vo["title"],0,8)); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
		 ...
		 <script type='text/javascript'>
			$(function(){				
				setInterval(function(){
					$("li.cc:last").hide().prependTo("#uid").slideDown(1500);			
				},3500);		
			});
