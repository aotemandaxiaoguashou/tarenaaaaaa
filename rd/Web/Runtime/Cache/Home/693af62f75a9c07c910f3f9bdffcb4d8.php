...
<html>
	...
	<link charset="utf-8" rel="stylesheet" href="http://static.easywed.cn/dist/js/lib/laydate/need/laydate.css?141110"><link charset="utf-8" rel="stylesheet" href="http://static.easywed.cn/dist/js/lib/laydate/skins/molv/laydate.css?141110"></head>
...
<div class="w pb20">
	...
	<ul class="fl">
					...
					<li><a href="/rd/index.php/cameraman/index"  class="on">婚礼摄像</a></li>
...
<div class="w pb20">
	<!--面包屑开始-->
	<div class="ui-nav-crumbs pt10 text-overflow">
		<a href="/rd/index.php/index">首页</a><i>&gt;</i><a href="/rd/index.php/Home/Cameraman/index">找婚礼人</a><i>&gt;</i>服务
	</div>
	<!--面包屑结束-->
	<!--主题内容开始-->
	<div class="wrap clx pt20">
		<div class="wrap-fl fl">
		<!--婚礼人信息开始-->
		<?php if(is_array($mod)): $i = 0; $__LIST__ = $mod;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="author clx">
	<div class="ui-photo c150-150 fl">
		<img width="150" height="150" src="/rd/Public/Uploads/marriager/<?php echo ($vo["pic"]); ?>" alt="<?php echo ($vo["name"]); ?>">
		<i class="hack"></i>
	</div>

	<div class="pl30 fl author-info pt16">
		<div class="author-name">
			<h2 class="text-overflow"><?php echo ($vo["name"]); ?></h2>
		</div>
                <!--易结认证-->
                <div class="vendors-easywed-rz mt10">
                    <p>易结认证</p>
                </div>            
            		<div class="author-address pt10">
						<span><i class="icons  icon-job-3"></i>摄像师</span>
					</div>

		<div class="author-hit">
			<p>
				<i class="icons icon-19"></i>赞<i class="num">66</i>
			</p>
			<p>
				<i class="icons icon-20"></i>浏览<i class="num">882</i>
			</p>
		</div>
                <!--易结价-->
                ...
                <!--普通-->
                                                ...
                                                <p class="vendors-easywed-price">易结价：￥4500</p>
                            
                     
                
	</div>
		<div class="author-about fr pt16">
		<h3 class="ui-h3 text-overflow">
			关于我
		</h3>
		<!-- 关于我的内容,需要去HTML代码 -->		
		<p class="pt10">
...
<ul class="clx">
	<li>
		<a href="/rd/index.php/Home/Cameraman/work/id/<?php echo ($vo["id"]); ?>">
			作品<i>7</i>			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Cameraman/serve/id/<?php echo ($vo["id"]); ?>" class="on">
			服务
			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Cameraman/price/id/<?php echo ($vo["id"]); ?>">
			报价
			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Cameraman/special/id/<?php echo ($vo["id"]); ?>">
			专栏<i></i>			<b class="arrow"></b>
		</a>
	</li>
</ul>
</div><?php endforeach; endif; else: echo "" ;endif; ?>		<!--标签结束-->
		<!--服务内容开始-->		
		<dl class="service-content pt20">
			<dt>基本信息</dt>
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><dd>
				<ul class="clx">
									<li class="clx">
							<p class="s-c-title">服务类别</p>
							<p class="s-c-txt"><?php echo ($vos["type"]); ?></p>
					</li>
										<li class="clx">
							<p class="s-c-title">提供服务的地域范围</p>
							<p class="s-c-txt"><?php echo ($vos["area"]); ?></p>
					</li>
										<li class="clx">
							<p class="s-c-title">支付方式？</p>
							<p class="s-c-txt"><?php echo ($vos["payment"]); ?></p>
					</li>
										<li class="clx">
							<p class="s-c-title">服务时间</p>
							<p class="s-c-txt"><?php echo ($vos["s_time"]); ?></p>
					</li>
					<li class="clx">
							<p class="s-c-title">服务语言</p>
							<p class="s-c-txt"><?php echo ($vos["language"]); ?></p>
					</li>
