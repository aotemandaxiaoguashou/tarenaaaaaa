...
<div class="nav" style="width:980px;">
	<div class="allshow">
		<?php if(is_array($deslist)): $i = 0; $__LIST__ = $deslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dlist): $mod = ($i % 2 );++$i;?><ul>
			<li><a href="/rd/index.php/Home/Dresses/info/id/<?php echo ($dlist["id"]); ?>" target="_self" title="<?php echo ($dlist["title"]); ?>"><img src="/rd/Public/<?php echo ($dlist["pic_name"]); ?>" alt="<?php echo ($dlist["title"]); ?>预订" height="170px"  style='border:solid 1px #fc2c93'></a></li>
			<li><a href="/rd/index.php/Home/Dresses/info/id/<?php echo ($dlist["id"]); ?>" target="_self" title="<?php echo ($dlist["title"]); ?>预订"><span class="allshow_title"><?php echo ($dlist["title"]); ?></span></a></li>
			<li><span class="allshow_style">市场价格：<del><?php echo ($dlist["sale"]); ?>元</del></span></li>
			<li><span class="allshow_style" style='color:#fc2c93'>优惠价格：<?php echo ($dlist["price"]); ?>元</span></li>
