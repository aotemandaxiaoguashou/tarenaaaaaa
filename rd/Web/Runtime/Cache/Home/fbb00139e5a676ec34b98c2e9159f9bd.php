...
<html>
	...
	<title>主持人 – 易结网 - 北京结婚 – 北京婚礼人 – 易结网</title>
...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
	...
	<dl class="clx">
		...
		<dd>
			<ul class="clx">
				<li>
					<a href="/rd/index.php/Home/Compere/index" class="on">全部</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Compere/index/sex/0">男</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Compere/index/sex/1">女</a>
				</li>
							</ul>
			...
			<ul class="clx">
				<li>
					<a href="/rd/index.php/Home/Compere/index" class="on">全部</a>
								...
								<li>
					<a href="/rd/index.php/Home/Compere/index/height/175,180">175-180</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Compere/index/height/170,175">170-175</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Compere/index/height/170">170以下</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Compere/index/height/180">180+</a>
				</li>
							</ul>
			...
			<ul class="clx">
				<li>
					<a href="/rd/index.php/Home/Compere/index/" class="on">全部</a>
								...
								<li>
					<a href="/rd/index.php/Home/Compere/index/age/30,40">80后</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Compere/index/age/40,50">70后</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Compere/index/age/50,60">60后</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Compere/index/age/20,30">90后</a>
				</li>
							</ul>
							...
							<?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="clx">
                                <div class="vendors-list-photo is">
                                    ...
                                    <div class="ui-photo c150-150">
                                        <a href="/rd/index.php/Home/Compere/work/id/<?php echo ($vo["id"]); ?>" target="_blank">
                                            <img width="150" height="150" alt="主持人晨风" src="/rd/Public/Uploads/marriager/<?php echo ($vo['pic']); ?>" class="imgLoad" style="display: block;">
                                            <i class="hack"></i>
                                        </a>
                                    </div>
                                    <!--易结价修改-->
                                    ...
                                    <span>
										<a href="http://easywed.cn/vendors/263/opus" target="_blank"><!-- 有没有连接都行 -->
											<i class="text-overflow">7</i>
											作品
										</a>
                                    </span>
                                    <span>
                                        <i class="text-overflow">45</i>
                                        点赞
                                    </span>
                                    <span>
                                        <a href="http://easywed.cn/vendors/263/articles" target="_blank"><!-- 有没有连接都行 -->
											<i class="text-overflow">7</i>
                                              专栏
                                            </a>
                                    </span>
                                    ...
                                    <p class="vendors-easywed-price tc">易结价：￥4500</p>
                                ...
                                <div class="vendors-list-info">
                                    <div class="vendors-list-name">
                                        <h3>
                                            <a href="http://easywed.cn/vendors/263" target="_blank">
                                               <?php echo ($vo['name']); ?>                                            </a>
                                        </h3>
                                    </div>
                                    <!--易结认证-->
                                ...
                                <div class="vendors-list-img clx picbox">
                                    ...
                                    <!-- 图片  介绍的信息图片和作品图片-->
										...
										<?php if(is_array($vo['pics'])): $i = 0; $__LIST__ = $vo['pics'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><li>
												<div class="photo">
													<div class="heading"><span>主持人</span></div>
														<a href="/rd/index.php/Home/Compere/work/id/<?php echo ($vo["id"]); ?>" target="_blank">
														<div class="pic">
