...
<div class="w pb20">
	...
	<div class="ui-nav-crumbs pt10 text-overflow">
		<a href="/rd/index.php/Home/Compere/index">首页</a><i>&gt;</i><a href="_URL__/index">找婚礼人</a><i>&gt;</i>服务
	</div>
	<!--面包屑结束-->
	<!--主题内容开始-->
			...
			<h2 class="text-overflow"><?php echo ($vo["name"]); ?></h2>
                ...
                <div class="vendors-easywed-rz mt10">
            		...
            		<div class="author-address pt10">
						<span><i class="icons  icon-job-3"></i>主持人</span>
					</div>

		<div class="author-hit">
			<p>
				<i class="icons icon-19"></i>赞<i class="num">11</i>
			</p>
			<p>
				<i class="icons icon-20"></i>浏览<i class="num">44</i>
			</p>
		</div>
                <!--易结价-->
...
<ul class="clx">
	<li>
		<a href="/rd/index.php/Home/Compere/work/id/<?php echo ($vo["id"]); ?>">
			作品<i>7</i>			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Compere/serve/id/<?php echo ($vo["id"]); ?>" class="on">
			服务
			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Compere/price/id/<?php echo ($vo["id"]); ?>">
			报价
			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Compere/special/id/<?php echo ($vo["id"]); ?>">
