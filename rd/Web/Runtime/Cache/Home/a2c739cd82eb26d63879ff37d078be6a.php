...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
	...
	<ul class="fl">
        ...
        <div class="ui-nav-crumbs text-overflow pt10">
            <a href="/rd/index.php/Home/Cameraman/index">首页</a><i>&gt;</i>
			
									<a href="/rd/index.php/Home/Cameraman/index">摄像师</a><i>&gt;</i>
																																							<a href="/rd/index.php/Home/Cameraman/work/"></a>摄像师<i>&gt;</i>
			摄像师的不归之路        </div>
		<!-- 面包屑end-->
			...
			<div class="wrap-fr fr">
                ...
                <div class="opus-d-author">
                    <div class="ui-photo c150-150-2">
                        <a href="/rd/index.php/Home/Cameraman/work/id/<?php echo ($vos["id"]); ?>" target="_blank">
                            <img width="150" height="150" src="/rd/Public/Uploads/marriager/<?php echo ($vos["pic"]); ?>" alt="<?php echo ($vos["name"]); ?>">
                            <i class="hack"></i>
                        </a>
                    </div>
                    <div class="title text-overflow">
                        <a href="/rd/index.php/Home/Cameraman/work/id/<?php echo ($vos["id"]); ?>" target="_blank"><?php echo ($vos["name"]); ?></a>
                    </div>
                    <div class="job">
						                        <span>
                            <i class="icons  icon-job-3"></i>摄像师                        </span>
						                    </div>
                    <div class="hit">
