...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
	...
	<div class="w pb20">
        ...
        <div class="ui-nav-crumbs pt10 text-overflow">
             <a href="/rd/index.php/index">首页</a><i>&gt;</i><a href="/rd/index.php/Home/Cameraman/compere/index">找婚礼人</a><i>&gt;</i>作品
        </div>
	...
	<div class="pl30 fl author-info pt16">
		...
		<div class="author-hit">
			<p>
				<i class="icons icon-19"></i>赞<i class="num">33</i>
			</p>
			<p>
				<i class="icons icon-20"></i>浏览<i class="num">120</i>
			</p>
		</div>
                <!--易结价-->
                ...
                <!--普通-->
                                                ...
                                                <p class="vendors-easywed-price">易结价：￥6000</p>
...
<ul class="clx">
	<li>
		<a href="/rd/index.php/Home/Cameraman/work/id/<?php echo ($vo["id"]); ?>" class="on">
			作品<i></i>			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Cameraman/serve/id/<?php echo ($vo["id"]); ?>">
			服务
			<b class="arrow"></b>
		</a>
	</li>
	...
	<li>
		<a href="/rd/index.php/Home/Cameraman/special/id/<?php echo ($vo["id"]); ?>">
			专栏<i></i>			<b class="arrow"></b>
                ...
                <!-- 小分类导航, 如果没有则整个消失, 高亮添加 class=on -->
                <div class="ui-nav-sub pt20">
                                            <a href="/rd/index.php/Home/Cameraman/index" class="on">摄像师</a>
                                    </div>
                <!-- 没有列表数据显示 -->
                                    <!-- 数据列表如果没有数据不显示循环li标签 -->
                    <div class="opus-list pt20">
                    <ul class="opus-list-ul" id="j-list">
                                 <?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><!-- 如果 图片 > 3 && 图片 <  12 -->
                                <li class="mode-7">
                                    <!-- 如果图片 <= 3 -->
                                    <div class="opus-title">
                                        ...
                                        <div class="fl">
                                            <h4>
                                                <a href="/rd/index.php/Home/Cameraman/workInfo/id/<?php echo ($vos["id"]); ?>" style="font-size:20px;"><?php echo ($vos["xname"]); ?></a>
                                            </h4>
                                        </div>
                                        <div class="fr">
                                            <span></span>
