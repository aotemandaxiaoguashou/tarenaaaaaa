...
<div class="nav" style="width:980px;">
	<div class="allshow">
		<?php if(is_array($fivestar)): $i = 0; $__LIST__ = $fivestar;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fh): $mod = ($i % 2 );++$i;?><ul>
			<li><a href="/rd/index.php/Home/Hole/detail/id/<?php echo ($fh["id"]); ?>" target="_blank" title="<?php echo ($fh["holename"]); ?>"><img src="/rd/Public/Uploads/hole/<?php echo ($fh["pic"]); ?>" alt="<?php echo ($fh["holename"]); ?>预订" height="155" width="236"></a></li>
			<li><a href="#" target="_blank" title="<?php echo ($fh["holename"]); ?>预订"><span class="allshow_title"><?php echo ($fh["holename"]); ?></span></a></li>
			<li><span class="allshow_style">酒店类型：<?php if($fh["style"] == 0): ?>五星级酒店<?php elseif($fh["style"] == 1): ?>四星级酒店<?php elseif($fh["style"] == 2): ?>三星级酒店<?php elseif($fh["style"] == 3): ?>连锁酒店<?php else: ?>草坪婚宴酒店<?php endif; ?></span></li>
			<li><span class="allshow_style">婚宴价格：<?php echo ($fh["price"]); ?>元/桌</span></li>
			<li><span class="allshow_style">最大桌数：<?php echo ($fh["tabnum"]); ?>桌</span></li>
