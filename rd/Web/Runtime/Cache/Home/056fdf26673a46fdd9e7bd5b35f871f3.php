...
<title><?php echo ($linfo["title"]); ?></title>
	...
	<link rel="stylesheet" type="text/css" href="/rd/Public/css/foot.css">
	<link rel="stylesheet" type="text/css" href="/rd/Public/css/gonglue_channel.css">
	<link rel="stylesheet" type="text/css" href="/rd/Public/css/travel_center.css">
...
<div class="top-bread">
  <div class="bread"> <a href="/rd/index.php/honey">蜜月攻略</a>&nbsp;&gt;&nbsp; <em><?php echo ($linfo["title"]); ?></em></div>
</div>
<div class="box">
    ...
    <div class="hot clearfix"> 
      ...
      <div class="portlet" id="yw0">
        <div class="portlet-content">
          <div class="hot-left">
            <div class="hot-left-title">相关目的地</div>
            <div class="left-details">
			<?php if(is_array($lovelist)): $i = 0; $__LIST__ = $lovelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$llist): $mod = ($i % 2 );++$i;?><div class="hot-place"> 
				<a href="/rd/index.php/Home/Honey/info/id/<?php echo ($llist["id"]); ?>" class="scenery"><img src="/rd/Public/<?php echo ($llist["pic"]); ?>" height="50" width="50"></a> 
				<span class="scenery-details"> <a href="/rd/index.php/Home/Honey/info/id/<?php echo ($llist["id"]); ?>" target="_self" title="<?php echo ($llist["title"]); ?>"><?php echo ($llist["title"]); ?></a> </span> 
      ...
      <div class="clearfix note-center">
        <div class="center-head">
          <div class="context clearfix">
            <div class="author-left"><a href="#" target="_blank" class="about-auther"><img src="/rd/Public/<?php echo ($linfo["pic"]); ?>" height="74" width="75"></a></div>
            <div class="author-right"> <b><?php echo ($linfo["title"]); ?></b>
				
              <p><em id="author_name"><?php echo ($linfo["auther"]); ?></em>&nbsp;<span>发表于：<?php echo (date("Y-m-d H:i:s",$linfo["addtime"])); ?></span>&nbsp;&nbsp;&nbsp浏览数：<?php echo ($linfo["num"]); ?>		  
			  </p>
        ...
        <div id="daybox">
          <div class="room-context"><a href="#" target="_blank" class="relatedlink"><?php echo ($linfo["area_name"]); ?></a><br>
            <p style="line-height:24px;text-indent:nullem;text-align:left"> 
            <?php echo ($linfo["detail"]); ?>
			</p>
          </div>
        </div>
