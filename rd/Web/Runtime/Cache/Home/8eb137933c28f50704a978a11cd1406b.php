...
<html>
	...
	<title>最美新娘必读——穿婚纱走路有讲究哦！ - 专栏  - 易结网</title>
		...
		<link rel="stylesheet" type="text/css" href="/rd/Public/css/articles.css">
...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
    ...
    <div class="ui-nav-crumbs text-overflow pt10">
		<a href="/rd/index.php/Home/Compere/index">首页</a><i>&gt;</i><a href="/rd/index.php/Home/Compere/index">认证婚礼人专栏</a><i>&gt;</i>最美新娘必读——穿婚纱走路有讲究哦！    </div>


    <div class="wrap clx pt10" style="">
        <div class="wrap-fl fl" style="">
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h1 class="ui-h2 mt20"><?php echo ($vo["name"]); ?></h1>
            <div class="articles-content">
                                    <p>
		<?php echo ($vo["content"]); ?>
</p>
<p>
	<img src="/rd/Public/Uploads/image/<?php echo ($vo["pic"]); ?>" title="易结网" alt="易结网" >
        ...
        <div class="wrap-fr fr" style="">
                ...
                <div class="opus-d-author">
                    <div class="ui-photo c150-150-2">
                        <a href="/rd/index.php/Home/Compere/work/id/<?php echo ($vos["id"]); ?>" target="_blank">
                            <img width="150" height="150" src="/rd/Public/Uploads/marriager/<?php echo ($vos["pic"]); ?>" alt="<?php echo ($vo["pic"]); ?>">
                            <i class="hack"></i>
                        </a>
                    </div>
                    <div class="title text-overflow">
                        <a href="/rd/index.php/Home/Compere/work/id/<?php echo ($vos["id"]); ?>" target="_blank"><?php echo ($vos["name"]); ?></a>
                    </div>
                    <div class="job">
						                        <span>
                            <i class="icons  icon-job-3"></i>主持人                        </span>
						                    </div>
                    <div class="hit">
                        <span class="item-1 text-overflow">
                            <i class="icons icon-19"></i>赞<i id="j-zan-num" class="num">46</i>
                        </span>
                        <span class="item-2 text-overflow">
                            <i class="icons icon-21"></i>作品<i class="num">7</i>
                        </span>
                    </div>
					
                </div><?php endforeach; endif; else: echo "" ;endif; ?>
            <!-- 选择主持人说明 -->
            <div class="wrap-side mt20">
                <h3 class="ui-h3">如何选择主持人</h3>
                <div class="side-desc pt10">
                    <dl>
                        <dt>
                            选择技巧
                        </dt>
                        <dd>
                            热门主持人的档期一般非常紧张，我们建议您如果档期明确，越早约好。热门档期的主持人，超过50%在半年甚至1年前就已被预订
                        </dd>
                        <dt>
                            为什么要支付定金
                        </dt>
                        <dd>
                            如果您有看好的主持人，建议您直接预订他的档期，热门时间的主持人一般比较抢手，易结按照优先支付定金的顺序和主持人敲定档期，所以，如果您确定了人选，一定要尽快支持。
                        </dd>
                    </dl>
                    <strong>预定不成功，100%退款</strong>
                </div>
            </div>
