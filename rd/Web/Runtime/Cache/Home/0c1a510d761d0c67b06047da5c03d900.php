...
<div class="w pb20">
	...
	<div class="ui-nav-crumbs pt10 text-overflow">
		<a href="/rd/index.php/Home/Assigner/index">首页</a><i>&gt;</i><a href="/rd/index.php/Home/Assigner/index">布置师</a><i>&gt;</i>服务
	</div>
	<!--面包屑结束-->
	<!--主题内容开始-->
			...
			<h2 class="text-overflow"><?php echo ($vo["name"]); ?></h2>
                ...
                <div class="vendors-easywed-rz mt10">
            		...
            		<div class="author-address pt10">
						<span><i class="icons  icon-job-3"></i>布置师</span>
					</div>
...
<ul class="clx">
	<li>
		<a href="/rd/index.php/Home/Assigner/work/id/<?php echo ($vo["id"]); ?>">
			作品<i>7</i>			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Assigner/serve/id/<?php echo ($vo["id"]); ?>" class="on">
			服务
			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Assigner/price/id/<?php echo ($vo["id"]); ?>">
			报价
			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Assigner/special/id/<?php echo ($vo["id"]); ?>">
