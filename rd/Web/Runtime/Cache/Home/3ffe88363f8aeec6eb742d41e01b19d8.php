...
<div class="adclsaa_05">
	<div class="adclsaa_05_left">
		<div style="border-bottom: 1px dashed #E4E4E4;">
			<dt>婚宴类型:</dt>
			<dd><a href="/rd/index.php/Home/Hole/index" title="酷结婚宴酒店" rel="nofollow">全部</a>
				<a href="/rd/index.php/Home/Hole/five" title="五星级婚宴酒店">五星级酒店</a>&nbsp;
				<a href="/rd/index.php/Home/Hole/four" title="四星级婚宴酒店">四星级酒店</a>&nbsp;
				<a href="/rd/index.php/Home/Hole/three" title="三星级婚宴酒店">三星级酒店</a>&nbsp;
				<a href="/rd/index.php/Home/Hole/chain" title="知名连锁酒店婚宴预订">连锁酒店</a>&nbsp;
				<a href="/rd/index.php/Home/Hole/sod" title="婚宴草坪酒店预订">婚宴草坪酒店</a>&nbsp;
			</dd>
		</div>
...
<div class="nav" style="width:980px;">
	<div class="allshow">
		<?php if(is_array($holes)): $i = 0; $__LIST__ = $holes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hole): $mod = ($i % 2 );++$i;?><ul>
			<li><a href="/rd/index.php/Home/Hole/detail/id/<?php echo ($hole["id"]); ?>" target="_blank" title="<?php echo ($hole["holename"]); ?>"><img src="/rd/Public/Uploads/hole/<?php echo ($hole["pic"]); ?>" alt="<?php echo ($hole["holename"]); ?>预订" height="155" width="236"></a></li>
			<li><a href="#" target="_blank" title="<?php echo ($hole["holename"]); ?>预订"><span class="allshow_title"><?php echo ($hole["holename"]); ?></span></a></li>
			<li><span class="allshow_style">酒店类型：<?php if($hole["style"] == 0): ?>五星级酒店<?php elseif($hole["style"] == 1): ?>四星级酒店<?php elseif($hole["style"] == 2): ?>三星级酒店<?php elseif($hole["style"] == 3): ?>连锁酒店<?php else: ?>草坪婚宴酒店<?php endif; ?></span></li>
			<li><span class="allshow_style">婚宴价格：<?php echo ($hole["price"]); ?>元/桌</span></li>
			<li><span class="allshow_style">最大桌数：<?php echo ($hole["tabnum"]); ?>桌</span></li>
...
var bd_cpro_rtid="PWRLP6";
</script>
<script type="text/javascript" src="/rd/Public/images/rt.js"></script>
<noscript>
<div style="display:none;">
<img height="0" width="0" style="border-style:none;" src="http://eclick.baidu.com/rt.jpg?t=noscript&rtid=PWRLP6" />
</div>
</noscript>
