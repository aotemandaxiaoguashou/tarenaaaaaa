...
<html>
	...
	<title>布置师 – 易结网 - 北京结婚 – 北京婚礼人 – 易结网</title>
...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
	...
	<dl class="clx">
		...
		<dd>
			<ul class="clx">
				<li>
					<a href="/rd/index.php/Home/Assigner/index" class="on">全部</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Assigner/index/sex/0">男</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Assigner/index/sex/1">女</a>
				</li>
							</ul>
			...
			<ul class="clx">
				<li>
					<a href="/rd/index.php/Home/Assigner/index" class="on">全部</a>
								...
								<li>
					<a href="/rd/index.php/Home/Assigner/index/height/175,180">175-180</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Assigner/index/height/170,175">170-175</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Assigner/index/height/170">170以下</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Assigner/index/height/180">180+</a>
				</li>
							</ul>
			...
			<ul class="clx">
				<li>
					<a href="/rd/index.php/Home/Assigner/index/" class="on">全部</a>
								...
								<li>
					<a href="/rd/index.php/Home/Assigner/index/age/30,40">80后</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Assigner/index/age/40,50">70后</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Assigner/index/age/50,60">60后</a>
				</li>
								<li>
					<a href="/rd/index.php/Home/Assigner/index/age/20,30">90后</a>
				</li>
							</ul>
							...
							<?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="clx">
                                <div class="vendors-list-photo is">
                                    ...
                                    <div class="ui-photo c150-150">
                                        <a href="/rd/index.php/Home/Assigner/work/id/<?php echo ($vo["id"]); ?>" target="_blank">
                                    ...
                                    <p class="vendors-easywed-price tc">易结价：￥5500</p>
                                ...
                                <div class="vendors-list-img clx picbox">
									...
									<?php if(is_array($vo['pics'])): $i = 0; $__LIST__ = $vo['pics'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><li>
											<div class="photo">
											<div class="heading"><span>布置师</span></div>
											<a href="/rd/index.php/Home/Assigner/work/id/<?php echo ($vo["id"]); ?>" target="_blank">
											<div class="pic">
