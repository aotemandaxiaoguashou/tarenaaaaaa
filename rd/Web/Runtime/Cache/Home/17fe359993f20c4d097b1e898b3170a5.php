...
<div class="clearfix page_area">
    <div class="user_default">
     	<div class="nav_2"></div>
     	<div class="title_s mb0"><span class="title01_s">填写订单信息</span></div>
       	<div class="flow p0">
        	<div class="order_title">配送地址<a href="/rd/index.php/Home/Indent/changeIndent/userid/<?php echo ($users["id"]); ?>">[修改]</a></div>
            <div class="address_info">
            	<table border="0" cellpadding="0" cellspacing="0" width="600">
                	<tbody>
						<tr>
							<td align="right" width="80">新人姓名：</td>
							<td align="left" width="320"><?php echo ($users["tname"]); ?></td>
							<td>&nbsp; </td>
						</tr>
					
						<tr>
						  <td align="right" width="80">详细地址：</td>
							<td align="left" width="320"><?php echo ($users["address"]); ?></td>
							<td align="left">（填写详细地址有助于快速配送） </td>
						</tr>
						<tr>
							<td align="right" width="80">邮政编码：</td>
							  <td align="left" width="320"><?php echo ($users["zipcode"]); ?></td>
							  <td>&nbsp; </td>
						</tr>

						<tr>
						  <td align="right" width="80">手机号码：</td>
							<td align="left" width="320"><?php echo ($users["phone"]); ?></td>
							<td>&nbsp; </td>
						</tr>
					</tbody>
				</table>
            ...
            <div class="order_title">商品列表<a href="/rd/index.php/Shopcar/index">[返回购物车]</a></div>
                
			
				<div class="address_info">
                    <table class="flow-tab-f3" bgcolor="#dcdcdc" cellpadding="0" cellspacing="1" width="100%">
						<thead>
							<tr>
								<th width="15%">商品图片</th>
								<th width="55%">商品名称</th>
						...
						<tbody>
						<?php if(is_array($info)): foreach($info as $key=>$inf): if(is_array($inf['goods'])): foreach($inf['goods'] as $key=>$goods): ?><tr id="content_3009">
						        <td><img class="f_l" width="29px" height="22px" src="/rd/Public/Uploads/goods/<?php echo ($goods["pic"]); ?>" alt="<?php echo ($goods["goodsname"]); ?>" onerror="this.src='static//rd/Public/images/product/default.gif'"></td>
						        <td class="name tab-f3-name">
						          <?php echo ($goods["goodsname"]); ?><br>
						        </td>
						        <td><del>￥<?php echo ($goods["mar-price"]); ?></del></td>
						        <td><strong class="f_red">￥<span id="cart_price_3009"><?php echo ($goods["price"]); ?></span></strong></td>
						        <td><?php echo ($inf["total"]); ?></td>
				...
				<div>
					<div class="p10 count-f1">
                        <div class="tr">商品金额：<em><?php echo ($info["all-price"]); ?>元</em></div>
						<div class="tr">运费：<em>0.00元</em></div>
						<div class="tr">应付总额：<em><span class="f_red">￥<?php echo ($info["all-price"]); ?></span> 元</em></div>
                    </div>
					<form name="form1" id="form1" method="post" action="/rd/index.php/Home/Indent/doUpIndent" onsubmit="return checkCart()">
						<input name="userid" value="<?php echo ($users["id"]); ?>" type="hidden">
						<input name="username" id="os" value="<?php echo ($users["username"]); ?>" type="hidden">
						<input name="linkman" id="recommend" value="<?php echo ($users["tname"]); ?>" type="hidden">
						<input name="phone" id="vp_number" value="<?php echo ($users["phone"]); ?>" type="hidden">
						<input name="email" id="usejifen" value="<?php echo ($users["email"]); ?>" type="hidden">
						<input name="address" id="address_id" value="<?php echo ($users["address"]); ?>" type="hidden">
						<input name="zipcode" id="recomm_type" value="<?php echo ($users["zipcode"]); ?>" type="hidden">
						<input name="all-price" id="recomm_gifts" value="<?php echo ($info["all-price"]); ?>" type="hidden">
						<input name="points" id="recomm_gifts" value="<?php echo ($info["all-point"]); ?>" type="hidden">
						<div class="submt_button">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tbody>
									<tr>
										<td align="right">
											<label><span>提交订单 应付总额:<b>￥<?php echo ($info["all-price"]); ?></b>元</span><input value="" type="submit"></label>
										</td>
									</tr>
								</tbody>
							</table>
