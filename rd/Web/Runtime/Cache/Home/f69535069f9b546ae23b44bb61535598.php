	...
	<div id="nav">
		<div class="w">
			<ul class="fl">
				...
				<?php if(is_array($columns)): $i = 0; $__LIST__ = $columns;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$col): $mod = ($i % 2 );++$i;?><li>
                    <a href="/rd/index.php/Home/Goods/<?php echo ($col['english']); ?>" target="_blank"><?php echo ($col['columnname']); ?></a>
...
<div class="case">
    <div class="case-title">
        <span class="line"></span><span class="case-title1">礼炮</span> <div class="case-title2"><a href="/rd/index.php/Home/Goods/salute" target="_blank">更多</a> </div>
    </div>
    <div class="case-mian">
        <ul>
			<?php if(is_array($salute)): $i = 0; $__LIST__ = $salute;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sal): $mod = ($i % 2 );++$i;?><li class="case1">
                <div class="caseimg">
                    <a href="/rd/index.php/Home/Goods/detail/id/<?php echo ($sal["id"]); ?>" target="_blank"> <span class="big-transparency"></span><img src="/rd/Public/Uploads/goods/<?php echo ($sal["pic"]); ?>" style="width:280px;height:199px;"></a>
                    <div class="price">￥<?php echo ($sal["price"]); ?></div>
                </div>
                <div class="case1-l" style="width:268px;height:80px;">
					<p><span class="allshow_style">商品积分：<?php echo ($sal["points"]); ?></span></p>
					<p><a href="/rd/index.php/Home/Goods/detail/id/<?php echo ($sal["id"]); ?>" target="_blank"><span class="allshow_title"><?php echo ($sal["goodsname"]); ?></span></a></p>
				</div>
            </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
...
<!--家庭装饰品-->
	<div class="case">
    <div class="case-title">
        <span class="line"></span><span class="case-title1">家庭装饰品</span> <div class="case-title2"><a href="/rd/index.php/Home/Goods/decoration" target="_blank">更多</a> </div>
    </div>
    <div class="case-mian">
        <ul>
			<?php if(is_array($decoration)): $i = 0; $__LIST__ = $decoration;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$deco): $mod = ($i % 2 );++$i;?><li class="case1">
                <div class="caseimg">
                    <a href="/rd/index.php/Home/Goods/detail/id/<?php echo ($deco["id"]); ?>" target="_blank"> <span class="big-transparency"></span><img src="/rd/Public/Uploads/goods/<?php echo ($deco["pic"]); ?>" style="width:280px;height:199px;"></a>
                    <div class="price">￥<?php echo ($deco["price"]); ?></div>
                </div>
                <div class="case1-l" style="width:268px;height:80px;">
                    <p><span class="allshow_style">商品积分：<?php echo ($deco["points"]); ?></span></p>
					<p><a href="/rd/index.php/Home/Goods/detail/id/<?php echo ($deco["id"]); ?>" target="_blank"><span class="allshow_title"><?php echo ($deco["goodsname"]); ?></span></a></p>
...
<div class="case">
    <div class="case-title">
        <span class="line"></span><span class="case-title1">鲜花</span> <div class="case-title2"><a href="/rd/index.php/Home/Goods/flower" target="_blank">更多</a> </div>
    </div>
    <div class="case-mian">
        <ul>
            <?php if(is_array($flower)): $i = 0; $__LIST__ = $flower;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$flo): $mod = ($i % 2 );++$i;?><li class="case1">
                <div class="caseimg">
                    <a href="/rd/index.php/Home/Goods/detail/id/<?php echo ($flo["id"]); ?>" target="_blank"> <span class="big-transparency"></span><img src="/rd/Public/Uploads/goods/<?php echo ($flo["pic"]); ?>" style="width:280px;height:199px;"></a>
                    <div class="price">￥<?php echo ($flo["price"]); ?></div>
                </div>
                <div class="case1-l" style="width:268px;height:80px;">
                    <p><span class="allshow_style">商品积分：<?php echo ($flo["points"]); ?></span></p>
					<p><a href="/rd/index.php/Home/Goods/detail/id/<?php echo ($flo["id"]); ?>" target="_blank"><span class="allshow_title"><?php echo ($flo["goodsname"]); ?></span></a></p>
                </div>
				</li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
...
<div class="case">
    <div class="case-title">
        <span class="line"></span><span class="case-title1">化妆品</span> <div class="case-title2"><a href="/rd/index.php/Home/Goods/toiletry" target="_blank">更多</a> </div>
    </div>
    <div class="case-mian">
        <ul>
             <?php if(is_array($toiletry)): $i = 0; $__LIST__ = $toiletry;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$toile): $mod = ($i % 2 );++$i;?><li class="case1">
                <div class="caseimg">
                    <a href="/rd/index.php/Home/Goods/detail/id/<?php echo ($toile["id"]); ?>" target="_blank"> <span class="big-transparency"></span><img src="/rd/Public/Uploads/goods/<?php echo ($toile["pic"]); ?>" style="width:280px;height:199px;"></a>
                    <div class="price">￥<?php echo ($toile["price"]); ?></div>
                </div>
                <div class="case1-l" style="width:268px;height:80px;">
					<p><span class="allshow_style">商品积分：<?php echo ($toile["points"]); ?></span></p>
					<p><a href="/rd/index.php/Home/Goods/detail/id/<?php echo ($toile["id"]); ?>" target="_blank"><span class="allshow_title"><?php echo ($toile["goodsname"]); ?></span></a></p>
