...
<div class="w pb20">
	...
	<div class="ui-nav-crumbs pt10 text-overflow">
		<a href="/rd/index.php/Home/Cameraman/index">首页</a><i>&gt;</i><a href="/rd/index.php/Home/Cameraman/index">找婚礼人</a><i>&gt;</i>报价
	</div>
	<!--面包屑结束-->
	<!--主题内容开始-->
	<?php if(is_array($mod)): $i = 0; $__LIST__ = $mod;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="wrap clx pt20">
            <div class="wrap-fl fl">
		<!--婚礼人信息开始-->
		<div class="author clx">
	...
	<div class="pl30 fl author-info pt16">
		...
		<div class="author-hit">
			<p>
				<i class="icons icon-19"></i>赞<i class="num">1</i>
			</p>
			<p>
				<i class="icons icon-20"></i>浏览<i class="num">46</i>
			</p>
		</div>
                <!--易结价-->
                ...
                <!--普通-->
                                                ...
                                                <p class="vendors-easywed-price">易结价：￥5000</p>
...
<ul class="clx">
	...
	<li>
		<a href="/rd/index.php/Home/Cameraman/price/id/<?php echo ($vo["id"]); ?>" class="on">
			报价
			<b class="arrow"></b>
		</a>
	</li>
	<li>
		...
		<!--报价开始-->
		<table class="price-content mt20">
			<thead>
				<tr>
					<td class="type" width="25%">服务类型</td>
					<td width="55%">说明</td>
					<td class="price" width="20%">价格</td>
				</tr>
			</thead>
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><tbody>
					<tr class="odd">
							<td class="tc type"><?php echo ($vos["type"]); ?></td>
							<td class="info"><?php echo ($vos["detail"]); ?></td>
							<td class="tc price"><?php echo ($vos["price"]); ?></td>
					</tr>
