...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
    ...
    <div class="ui-nav-class  clx">
		<ul class="fl">
					<li><a href="/rd/index.php/compere/index" class="on">主持人</a></li>
	...
	<div class="w pb20">
        ...
        <div class="ui-nav-crumbs pt10 text-overflow">
             <a href="__URL_/index">首页</a><i>&gt;</i><a href="/rd/index.php/Home/Compere/index">找婚礼人</a><i>&gt;</i>作品
        </div>
	...
	<div class="ui-photo c150-150 fl">
		<img width="150" height="150" src="/rd/Public/Uploads/marriager/<?php echo ($vo["pic"]); ?>" alt="">
		<i class="hack"></i>
	</div>
	...
	<div class="pl30 fl author-info pt16">
		...
		<div class="author-hit">
			<p>
				<i class="icons icon-19"></i>赞<i class="num">46</i>
			</p>
			<p>
				<i class="icons icon-20"></i>浏览<i class="num">320</i>
			</p>
		</div>
                <!--易结价-->
                ...
                <!--普通-->
                                                ...
                                                <p class="vendors-easywed-price">易结价：￥3000</p>
...
<ul class="clx">
	<li>
		<a href="/rd/index.php/Home/Compere/work/id/<?php echo ($vo["id"]); ?>" class="on">
			作品<i></i>			<b class="arrow"></b>
		</a>
	</li>
	<li>
		<a href="/rd/index.php/Home/Compere/serve/id/<?php echo ($vo["id"]); ?>">
			服务
			<b class="arrow"></b>
		</a>
	</li>
		...
		<a href="/rd/index.php/Home/Compere/special/id/<?php echo ($vo["id"]); ?>">
			专栏<i></i>			<b class="arrow"></b>
                ...
                <div class="ui-nav-sub pt20">
                                            <a href="/rd/index.php/Home/Compere/index" class="on">主持人</a>
                                    </div>
                <!-- 没有列表数据显示 -->
                                    <!-- 数据列表如果没有数据不显示循环li标签 -->
                    ...
                    <ul class="opus-list-ul" id="j-list">
                                ...
                                <li class="mode-7">
                                    ...
                                    <div class="opus-title">
                                        ...
                                        <div class="fl">
                                            <h4>
                                                <a href="/rd/index.php/Home/Compere/workInfo/id/<?php echo ($vos["id"]); ?>" style="font-size:20px;"><?php echo ($vos["xname"]); ?></a>
                                            </h4>
                                        </div>
                                        <div class="fr">
                                            <span></span>
