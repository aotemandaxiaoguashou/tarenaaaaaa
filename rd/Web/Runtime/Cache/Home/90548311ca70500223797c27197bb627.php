...
<!--*********(BLOCK=eachCONTENT)开始，各页面中间的自己独有的部分*****************************************************************************************-->
  ...
  <span>当前位置：</span><a href="/rd/index.php/Index/index">首页</a>&gt; <em>修改密码</em>
</div>
<div class="w clearfix mb15">
    ...
    <div class="clearfix user-content">
      <div class="clearfix p10 mb10">
        ...
        <form method="post" action="/rd/index.php/Home/User/dochangepwd">
...
<script>
	function checkOldPassword(){
		...
		$.post('/rd/index.php/Home/User/checkpwd',data,function(d){
			if(d=='success'){
				return true;
			}else{
				alert('原密码输入错误');
